<template>
    <section class="grid md:grid-cols-2 gap-8 items-start px-6">
        <div class="space-y-4">
            ...
            <p class="text-base">Reach eportsolutions.co.tz for support, onboarding, or inquiries.</p>
            ...
            <div v-if="message" class="text-base">{{ message }}</div>
        </div>
        <div v-if="!user" class="space-y-4">
            <h2 class="text-2xl font-semibold">Get Started</h2>
            <p class="text-base">Register an account to manage your DSE portfolio alerts.</p>
